...
User.create(email: 'admin@gmail.com', admin: true, demand: false, password_digest: BCrypt::Password.create('secret'))

user1 = User.create(email: 'john@gmail.com', admin: false, password_digest: BCrypt::Password.create('secret'))
